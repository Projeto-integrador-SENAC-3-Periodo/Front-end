...
// Função central de requisição: injeta token e trata erros HTTP
...
export interface ApiActivity {
  ...
  // Campos extras retornados pelo backend
  idAluno?: string;
...
// Converte a linha crua do backend para o formato ApiActivity
...
// Converte o status do backend (APROVADO/REJEITADO) para o padrão do frontend
...
// Conta apenas alunos vinculados (exclui coordenadores)
...
export const coursesApi = {
  list: async (): Promise<ApiCourse[]> => {
    ...
    // Enriquece cada curso com contagem de alunos e nome do coordenador
...
// Campos aceitos ao criar ou editar uma atividade
...
export const activitiesApi = {
  ...
  create: async (data: ActivityMutateInput): Promise<ApiActivity> => {
    const body = {
      ...
      tipoComprovante: data.proofType ?? null,
    };
...
export const proofsApi = {
  // Busca todas as comprovações agrupando por atividade
...
export const userCursoApi = {
  ...
  // Retorna apenas alunos, filtrando coordenadores do mesmo vínculo
